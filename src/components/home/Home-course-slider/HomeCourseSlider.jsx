...
import coursepic from "../../../assets/images/New-blue-modern-website-programming-online-tutorials-youtube-thumbnail-1.jpg";
    ...
    <div className="swiper-container">
      <div className="container">
        ...
        <p className="container-p">
          xplore our diverse course catalog designed to meet your learning
          needs. Whether you're looking to enhance your skills, pursue a new
          career path, or simply broaden your knowledge, we offer a wide range
          of courses to cater to your interests.
        </p>
      </div>
            ...
            <div className="slide-content w-100">
              ...
              <div className="slide-content-inner mb-4">
                ...
                <p className="text-start text-white">
                  ...
                  Java Programming Master's Program.
                </p>
              </div>
              <hr />
          ...
          <div className="container">
            <div className="slide-content w-100">
              ...
              <div className="slide-content-inner mb-4">
                ...
                <p className="text-start text-white">
                  Secure Your Future with Expertise: Master the Science of
                  Information Security, Safeguarding Tomorrow's Digital
                  Landscape.
                </p>
              </div>
              <hr />
        ...
        <div className="swiper-slide">
          ...
          <div className="container">
            <div className="slide-content w-100">
              ...
              <div className="slide-content-inner mb-4">
                <h2 className="text-start">Business Administration</h2>
                <p className="text-start text-white">
                  Lead with Knowledge: Master the Science of Business
                  Administration, Shaping Tomorrow's Business Landscape.
                </p>
              </div>
              <hr />
              <div className="course_icon_btn mt-4 d-flex align-items-center justify-content-end">
